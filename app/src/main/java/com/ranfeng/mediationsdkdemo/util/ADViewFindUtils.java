package com.ranfeng.mediationsdkdemo.util;
...
public class ADViewFindUtils {
    ...
    public static View tryGetTheFrontView(Activity targetActivity) {
        try {
            ...
            Field mGlobalField = ADClassFindUtils.getDeclaredField(ADClassFindUtils.forName("android.view.WindowManagerImpl"), "mGlobal");
            ...
            if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.M) {
                ...
                Field mRootsField = ADClassFindUtils.getDeclaredField(ADClassFindUtils.forName("android.view.WindowManagerGlobal"), "mRoots");
                ...
                for (int i = viewRootImpls.size() - 1; i >= 0; i--) {
                    Class clazz = ADClassFindUtils.forName("android.view.ViewRootImpl");
                    Object object = viewRootImpls.get(i);
                    Field mWindowAttributesField = ADClassFindUtils.getDeclaredField(clazz, "mWindowAttributes");
                    mWindowAttributesField.setAccessible(true);
                    Field mViewField = ADClassFindUtils.getDeclaredField(clazz, "mView");
