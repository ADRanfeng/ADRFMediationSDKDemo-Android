 ...
 * @description 信息流广告示例
 */
public class NativeExpressAdActivity extends BaseAdActivity implements OnRefreshLoadMoreListener {
    ...
    private void initAd() {
        ...
        ExtraParams extraParams = new ExtraParams.Builder()
                ...
                .build();
        // 设置一些额外参数，有些平台的广告可能需要传入一些额外参数，如果有接入头条，如果包含这些平台该参数必须设置
    ...
    private void loadData() {
        ...
        rfNativeAd.loadAd(ADRFDemoConstant.NATIVE_AD_POS_ID1, ADRFDemoConstant.NATIVE_AD_COUNT);
    }
        ...
        new AlertDialog.Builder(this)
                .setItems(R.array.native_ad_list, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        RFToastUtil.show(NativeExpressAdActivity.this, toastContent);
                        dialog.dismiss();
                        nativeAdAdapter.clearData();
                        loadData();
                    }
