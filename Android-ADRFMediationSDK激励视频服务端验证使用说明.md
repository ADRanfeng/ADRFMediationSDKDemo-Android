## ADRFMediationSDK 激励视频服务端验证使用说明
    ...
    private void initAd() {
        ...
        rewardVodAd.setListener(new RFRewardVodAdListener() {
            ...
            public void onReward(RFRewardVodAdInfo rfRewardVodAdInfo) {
                ...
                if (platformFlag.equals(rfRewardVodAdInfo.getPlatform())) {
                    Map<String, Object> rewardMap = rfRewardVodAdInfo.getRewardMap();
                    if (rewardMap != null) {
                        //获取服务端验证的唯一 ID
...
```java
    ...
    private void initAd() {
        ...
        rewardExtra.setCustomData("设置自定义附带参数");
...
```java
    ...
    private void initAd() {
        ...
        rewardExtra.setRewardCallbackExtraData(rewardCallbackExtraData);
...
/**
    ...
    private void initAd() {
        ...
        rewardExtra.setCustomData("设置自定义参数");
